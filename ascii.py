...
def main():
    ...
    parser.add_argument(
        "--file", dest="input_file", required=True, help="path/to/image/file"
    )
    parser.add_argument(
        "--out", dest="out_file", required=False, help="path/to/output/file"
    )
    parser.add_argument(
        "--cols", dest="cols", required=False, help="columns in outut image"
    )
